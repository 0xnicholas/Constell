...
- Dev watch build: `pnpm --filter @constell/ee run dev`
- Lint: `pnpm --filter @constell/ee run lint`
- Lint fix: `pnpm --filter @constell/ee run lint:fix`
- Typecheck: `pnpm --filter @constell/ee run typecheck`
- Build: `pnpm --filter @constell/ee run build`

## Integration Notes

- `ee` depends on `@constell/shared`; coordinate shared type changes carefully.
